...
**Discovered during**: ruthmarks/add-wildflower-node — review of [slices/contracts/contracts-core/tests/bridge.test.ts](slices/contracts/contracts-core/tests/bridge.test.ts)
