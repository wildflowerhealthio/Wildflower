...
- [Effect Patterns Reference](../../../../docs/Patterns%20Reference.md) — Layer composition, generator syntax
- [HttpApi Composition How-To](../../../../docs/HttpApi%20Composition%20How-To.md) — A related cross-package phantom-id cast pattern
