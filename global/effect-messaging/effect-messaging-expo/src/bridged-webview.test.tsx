...
import { Bridge, type HostBinding } from 'effect-messaging-core'
...
describe('BridgedWebView (integration)', () => {
  it('completes the __Ready handshake and round-trips messages in both directions', async () => {
    ...
    let capturedSend: HostBinding.BindingSend | null = null
    ...
    render(
      <BridgedWebView
        ...
        bindings={[binding] as unknown as ReadonlyArray<HostBinding.Any>}
      />
    )
    ...
    // `TransportReadyCaller`'s `useEffect` forks each binding's
