...
export default defineConfig({
  ...
  fmt: {
    ...
    ignorePatterns: [
      ...
      // Compact DDInter interaction catalog generated by
      // `vp run -F medications-app data:ddinter` — a single-line JSON of
      // ~200k index triples; pretty-printing it would add a million lines.
      'apps/medications-app/src/data/ddinter/*.json',
      '**/autogenerated/**/*',
