 ...
 *
 * @remarks
 * The one place the seams meet — {@link decodeLifeLabsPdf},
 * {@link lifeLabsPdfSource}, {@link persistFhir} — listed by the shell's
 * closed registry. The review between decode and persist is format-agnostic
 * (`Review`), so it is not named here.
 */
