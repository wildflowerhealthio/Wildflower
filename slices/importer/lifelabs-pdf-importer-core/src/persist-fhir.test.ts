...
/**
 * Covers the LifeLabs PDF binding's write sink. Two properties matter and both are
...
/** The source `DocumentReference` every imported resource points back to. */
const SOURCE_REF = 'DocumentReference/lifelabs-report-1'
