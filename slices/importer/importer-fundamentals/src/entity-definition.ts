...
import type { ImportableResponse } from './importable-response.ts'
 ...
 * needs and takes the {@link ImportableResponse} each call. Passing
 ...
 *   match wins.
 * - `parse`: `Effect`-returning decode from {@link ImportableResponse}
