/**
 * The FHIR R4 importer project: how FHIR R4 traffic decodes into resources,
 * and the assembled importer built from that decode.
 *
 * @remarks
 ...
 *   package's importer surface and by the live scraping plan in
 ...
 *   importer entities (`fhirR4ImporterEntities`, keying each resource under
 *   the root of the URL it arrived on);
 * - `fhirR4Importer`, the whole importer as one `Importer.Importer` value an
 *   import pipeline registers.
 *
...
export { fhirR4ImporterEntities } from './importer-entities.ts'
export { fhirR4Importer } from './importer.ts'
