...
import type { Extraction, Recognizer } from 'importer-fundamentals'
 ...
 * FHIR R4 importer when any URL matches an entity pattern. This package owns
 ...
 *
 * @remarks
 * The intended order across importers is portal-specific above
 ...
 * separates this from a portal-specific importer, not a stricter predicate.
 */
