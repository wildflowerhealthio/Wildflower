module.exports = {
  ...
  // browser-sniffer-expo migration; the replacement screen and tests
  // land in a follow-up PR. Without this flag the root-level
  // `vp run -r --concurrency-limit 1 jest` exits 1 on the empty package.
