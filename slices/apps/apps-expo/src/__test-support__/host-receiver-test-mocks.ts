...
import type { BareSender } from 'effect-messaging-core'
...
interface MockHarness {
  ...
  lastHandlers?: {
    ...
    readonly RequestTunnel: () => import('effect').Effect.Effect<void, never, BareSender>
  } | null
  sentMessages?: Array<
 ...
 * standing up a transport) and records every `AppsBridge.Host.send`
 * call into `harness.sentMessages`.
 */
  ...
  return {
    ...
    default: {
      Host: {
        ...
        send: (
          message: NonNullable<MockHarness['sentMessages']>[number]
