 ...
 * isn't registered (standalone build, or a host slice's router) —
 * without a registered Router, `useRouteContext()` widens to `any`; the
 * explicit `(context: RouterContext)` annotation re-narrows it with no
 * cast.
 */
