"use strict";
(() => {
  // slices/browser-sniffer/browser-sniffer-injected/src/sniffer-script.generated.ts
  ...
  // slices/browser-sniffer/browser-sniffer-injected/src/index.ts
  ...
  // slices/browser-sniffer/browser-sniffer-tauri/src/tauri-sniffer-entry.ts
  var win = globalThis;
  ...
  if (event !== void 0) {
    ...
    const inboundTags = ["Click", "CancelSnifferRequest"];
