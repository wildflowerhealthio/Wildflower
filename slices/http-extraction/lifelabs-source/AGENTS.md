...
and Canadian/LifeLabs sources. What went into `LOINC_UNITS`, and what was left
out on purpose:

| Group       | LOINC → unit                                                                                                                                                                                                                                                                           | Why                                                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CBC         | `6690-2` WBC, `53115-2` immature granulocytes → `x E9/L`; `789-8` RBC → `x E12/L`; `718-7` Hgb → `g/L`; `4544-3` Hct → `L/L`                                                                                                                                                           | WBC/Hgb from the summary's own ranges, RBC from a real `ViewAnalytics`; Hct is a fraction in Canadian reporting, not `%`                                                        |
| Chemistry   | Na `2951-2`, K `2823-3`, Ca `2000-8`, urea `22664-7`, fasting glucose `14771-0`, lithium `14334-7` → `mmol/L`; creatinine `14682-9`, urate `14933-6`, total bilirubin `14631-6` → `umol/L`; ALT `1742-6`, AST `1920-8` → `U/L`; eGFR `33914-3` → `mL/min/1.73m2`; HbA1c `4548-4` → `%` | LOINC `[Moles/volume]` / `[Enzymatic activity/volume]` property + Canadian SI convention; eGFR unit confirmed by LifeLabs' CKD-EPI 2021 notice; Ontario reports A1c as NGSP `%` |
...
and the low-confidence ones whose printed spelling is unverified (urine
erythrocytes `20409-9`, NRBC `19048-8`, hours-post-dose `45359-7`,
hours-after-meal `55420-4`). Sources: LifeLabs' urinalysis-platform (2021),
