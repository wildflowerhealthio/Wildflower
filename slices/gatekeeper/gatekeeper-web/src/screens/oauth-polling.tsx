      ...
      <Await
        ...
        errorElement={
          <AsyncErrorView
            ...
            className="gk-poll"
            titleClassName="gk-poll-declined"
          />
        }
      >
...
const PollingResult = ({ status }: PollingResultProps): JSX.Element => {
  ...
  if (status.status === 'denied') {
    return (
      <div className="gk-page gk-poll">
        <h1 className="gk-poll-declined text-heading-4">Request Declined</h1>
  ...
  if (status.status === 'error') {
    return (
      <div className="gk-page gk-poll">
        <h1 className="gk-poll-declined text-heading-4">Authorization Error</h1>
