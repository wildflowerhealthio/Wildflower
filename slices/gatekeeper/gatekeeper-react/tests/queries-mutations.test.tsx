...
import { useDeviceConsentMutation } from '../src/queries/device-consent.ts'
import { useRevokeGrantMutation } from '../src/queries/grants.ts'
import { useOAuthConsentMutation } from '../src/queries/oauth-consent.ts'
import { useDecideRequestMutation } from '../src/queries/requests.ts'
