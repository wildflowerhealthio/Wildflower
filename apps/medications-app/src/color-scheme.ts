/*
 * Colour-scheme wiring for the standalone medication app.
 *
 ...
 * `apply-color-scheme` / `add-os-color-scheme-listener` pair; the medication app
 * pulls in neither (it has no navigation bridge / router), so the minimal logic
 * lives here.
 */
