 ...
 * `apps/wildflower-server/src/http-api-definition.ts`, the collector
 * group's `middlewares` set loses the `RequireAuthMiddleware` tag and
 * write endpoints silently expose to unauthenticated clients.
 *
