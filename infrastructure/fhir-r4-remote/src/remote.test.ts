...
describe('FhirR4Remote', () => {
  ...
  describe('shouldKeepResponse()', () => {
    it('should keep responses matching Patient URLs', () => {
      ...
      expect(
        remote.shouldKeepResponse({
          id: 'r1',
          url: 'https://r2.smarthealthit.org/Patient/123',
          status: 200,
          statusText: 'OK',
          headers: {},
        })
    ...
    it('should not keep responses for non-Patient URLs', () => {
      const remote = new FhirR4Remote(defaultConfig, () => {})

      expect(
        remote.shouldKeepResponse({
          id: 'r1',
          url: 'https://r2.smarthealthit.org/Observation/456',
          status: 200,
          statusText: 'OK',
          headers: {},
        })
  ...
  describe('lifecycle', () => {
    it('should handle register, stream, and finish', () => {
      ...
      const kept = remote.shouldKeepResponse({
        id: 'lifecycle-1',
        url: 'https://r2.smarthealthit.org/Patient/42',
        status: 200,
        statusText: 'OK',
